...
export var MaskedTextBoxComponent = (function () {
    ...
    MaskedTextBoxComponent.prototype.inputHandler = function (e) {
        ...
        if (this.isPasted) {
            this.isPasted = false;
            var diff = Math.abs(this.maskedValue.length - value.length);
            var to = diff === 0 ? end : start + diff;
    ...
    MaskedTextBoxComponent.prototype.ngOnChanges = function (changes) {
        ...
        else if (next.promptPlaceholder !== undefined || next.includeLiterals !== undefined) {
