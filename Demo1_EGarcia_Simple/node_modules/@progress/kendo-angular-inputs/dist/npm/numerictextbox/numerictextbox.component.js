...
var NumericTextBoxComponent = (function () {
    function NumericTextBoxComponent(intl, renderer, rtl) {
        this.intl = intl;
     ...
     * @hidden
     */
    NumericTextBoxComponent.prototype.keydown = function (e) {
        switch (e.keyCode) {
     ...
     * @hidden
     */
    NumericTextBoxComponent.prototype.handleFocus = function (e) {
        this.focused = true;
        if ((this.value || this.value === 0)) {
     ...
     * @hidden
     */
    NumericTextBoxComponent.prototype.handleBlur = function (e) {
