...
import { Renderer, ElementRef, OnDestroy, OnChanges, EventEmitter, AfterContentChecked, AfterViewInit, NgZone } from '@angular/core';
...
export declare class MultiSelectComponent implements OnDestroy, OnChanges, AfterContentChecked, AfterViewInit {
     ...
     */
    click(): void;
    constructor(rtl: boolean, selectionService: SelectionService, renderer: Renderer, navigationService: NavigationService, wrapper: ElementRef, zone: NgZone);
