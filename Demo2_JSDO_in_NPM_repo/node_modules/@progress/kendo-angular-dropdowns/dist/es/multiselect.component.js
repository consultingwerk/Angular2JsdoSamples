...
import { ViewChild, Component, HostBinding, Input, Optional, Inject, Renderer, HostListener, ElementRef, Output, EventEmitter, isDevMode, forwardRef, ContentChild, NgZone } from '@angular/core';
...
export var MultiSelectComponent = (function () {
    function MultiSelectComponent(rtl, selectionService, renderer, navigationService, wrapper, zone) {
    ...
    MultiSelectComponent.prototype.subscribeEvents = function () {
        ...
        this.zone.runOutsideAngular(function () {
            _this.documentClick = Observable
                ...
                .filter(function (event) { return _this.wrapper === event.target && !_this.wrapper.contains(event.target); });
            _this.wrapperBlurred
                .concatMap(function () { return Observable.interval(10).take(1).takeUntil(Observable.fromEvent(_this.wrapper, 'focus')); })
                .merge(_this.navigationService.tab, _this.documentClick)
                .subscribe(function () { return _this.zone.run(function () { return _this.popupOpen = _this.isFocused ? !_this.open : false; }); });
        });
    };
