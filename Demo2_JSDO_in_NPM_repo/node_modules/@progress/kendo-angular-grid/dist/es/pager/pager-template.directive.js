 ...
 *
 * To define a pager template, nest a `<template>` tag with the `kendoPagerTemplate` directive inside `<kendo-grid>`.
 *
 ...
 *       </kendo-grid-column>
 *
 *       <template kendoPagerTemplate let-totalPages="totalPages" let-currentPage="currentPage">
 ...
 * ```
 */
export var PagerTemplateDirective = (function () {
