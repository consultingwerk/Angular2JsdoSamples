...
import { progress } from 'smartcomponents-jsdo';
...
export class CategoriesService extends BehaviorSubject<GridDataResult> {
    ...
    constructor(private http: Http) {
        ...
        const serviceURI = 'http://localhost:8820/web';
        const catalogURI = 'http://localhost:8820/web/Catalog/Consultingwerk.SmartComponentsDemo.OERA.Sports2000.CustomerBusinessEntity';
